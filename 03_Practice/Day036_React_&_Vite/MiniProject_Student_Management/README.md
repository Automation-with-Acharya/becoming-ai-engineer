...
│
├── frontend/                       # React + Vite frontend (Day 036)
...
│       ├── vite.config.js          # Vite config: @vitejs/plugin-react (JSX + Fast Refresh)
│       ├── package.json            # npm manifest: react, react-dom, vite, oxlint
│       ├── src/
│       │   ├── main.jsx            # React entry: createRoot → mounts <App> onto #root
│       │   ├── App.jsx             # Root component: state, mock data, component tree wire-up
│       │   ├── App.css             # App-level styles: layout, cards, badges, selected banner
│       │   ├── index.css           # Global reset: box-sizing, font, background
│       │   ├── data/
│       │   │   └── mockStudents.js # Exercise 5: local mock student array (id/name/age/city/email/active)
│       │   └── components/
│       │       ├── Header.jsx      # Exercise 4: app title bar
│       │       ├── Footer.jsx      # Exercise 4: bottom banner
│       │       ├── StudentSummary.jsx # Exercise 9: total/active/inactive stats
│       │       ├── StudentList.jsx # Exercise 4/6: maps students array → StudentCard
│       │       └── StudentCard.jsx # Exercise 6/7/8: single student record, badge, click handler
...
- 📦 **Mock Student Data** — `src/data/mockStudents.js` mirrors the `Student_response_model` shape (`id, name, age, city, email, active`); no API calls until Day 037+ (Exercise 5)
