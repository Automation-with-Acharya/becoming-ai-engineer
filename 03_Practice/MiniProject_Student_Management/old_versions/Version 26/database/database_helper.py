    ...
    def _create_table_if_not_exists(self) -> None:
        ...
        with self._pool.connection() as conn:
            with conn.cursor() as cur:
                ...
                # Migrate databases created before is_active was part of the model.
                cur.execute(
                    "ALTER TABLE students ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE"
                )
                cur.execute("UPDATE students SET is_active = TRUE WHERE is_active IS NULL")
                cur.execute("ALTER TABLE students ALTER COLUMN is_active SET DEFAULT TRUE")
                cur.execute("ALTER TABLE students ALTER COLUMN is_active SET NOT NULL")
