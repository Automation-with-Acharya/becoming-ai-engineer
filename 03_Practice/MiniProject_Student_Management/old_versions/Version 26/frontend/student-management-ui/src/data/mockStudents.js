 ...
 *   { id, name, age, city, email, is_active }
 *
 * The `is_active` field drives the status badge and summary.
 */
...
const students = [
  {
    ...
    is_active: true, // Exercise 7: drives the Active/Inactive badge
  },
  {
    id: 2,
    name: "Rahul Sharma",
  ...
  },
  {
    ...
    is_active: false, // Inactive student — renders the "Inactive" badge
  },
];
